...
;; library files you need it to look for.
;; Example:  (:clsql-lib-paths . ("/Users/me/Work/SQlite3-dist/" "/Users/me/Work/Postgresql-dist"))
;;
;; :pthread-lib is deprecated, for old versions of sbcl that did not have
;; pthreads compiled in.  If you are using an old version, we recommend that
;; you upgrade!  Typical pthread settings were: /lib/tls/libpthread.so.0
;;
;;
